...
run_perl(prog => 'use threads 1.91;' .
                 'threads->exit(86);' .
                 'exit(99);',
...
run_perl(prog => 'use threads 1.91 qw(exit thread_only);' .
...
my $out = run_perl(prog => 'use threads 1.91;' .
                           'threads->create(sub {' .
                           '    exit(99);' .
                           '});' .
                           'sleep(1);' .
...
$out = run_perl(prog => 'use threads 1.91 qw(exit thread_only);' .
                        'threads->create(sub {' .
